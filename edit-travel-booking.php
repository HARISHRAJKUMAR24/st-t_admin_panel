    ...
    <div class="main-wrapper">
        <div class="top-bar">
            ...
            <div class="greeting-center">
                ...
                <small>Edit Travel Booking</small>
            </div>
        </div>
                ...
                <form id="travelBookingForm" enctype="multipart/form-data">
                    ...
                    <div class="row-2col">
                        ...
                        <div>
                            <div class="section-title">
                                ...
                                <span class="badge-count" id="stopCount"><?= count($stops) ?> Stops</span>
                            </div>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn-submit" id="submitBtn">
                            <span id="submitText">Update Booking</span>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (form) {
                form.addEventListener('submit', function(e) {
                    ...
                    fetch('ajax/update-travel-booking.php', {
                            method: 'POST',
                            body: formData
                        })
                        .then(response => response.json())
